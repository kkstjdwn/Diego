		...
		<div id="listcontent2">
			<div class="">
				<div class="">
					<div class="titleArea">
						<h2>
							<font color="#555555">Notice Update</font>
						</h2>
					</div>
				</div>
				<form id="boardWriteForm" name="" action="./noticeUpdate" method="post" target="_self" enctype="multipart/form-data">
					<div class="">
						<div class="typeWrite ">
							<table border="1" summary="">
								...
								<tr style="display: none;">
									...
									<tr>
										<th scope="row">제목</th>
										<td><input type="text" class="form-control subject" id="title" name="title" value="${dto.title}"></td>
									</tr>
									...
									<tr>
										<td colspan="2" class="clear">
												<textarea class="form-control" rows="30" id="contents" name="contents">${dto.contents}</textarea>
											</td>
									</tr>
								</tbody>
							</table>
