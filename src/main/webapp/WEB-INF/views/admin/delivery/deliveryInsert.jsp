...
<form class="form-horizontal" action="deliveryInsert" method="post" enctype="application/x-www-form-urlencoded">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="del_num" name="del_num" >
    </div>
  </div>
      <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="del_address" name="del_address" >
    </div>
  </div>
        <div class="form-group">
    <label class="control-label col-sm-2" for="del_costpay">배송비 결제여부(Y/N)</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-success" id="insert">입력</button>
    </div>
  </div>
</form>
</body>
